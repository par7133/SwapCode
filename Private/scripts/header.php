...
-->
 ...
 <div id="HCsplash" style="padding-top: 40px; text-align:center;color:#d4b0dc;font-family:'Bungee Hairline';">
  ...
  <div class="header2" style="margin-top:18px; margin-left:38px; margin-bottom:18px; color:#000000; display:none;">
    &nbsp;&nbsp;<a href="http://swapcode.5mode-lab.com" target="_self" style=" text-decoration: none;"><img src="/res/code.png" style="width:25px;">&nbsp;SwapCode</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/par7133/SwapCode" style=""><span style="">on</span> github</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:posta@elettronica.lol" style=""><span style="">for</span> feedback</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:+39-331-4029415" style="font-size:13px;background-color:#15c60b;border:2px solid #15c60b;color:#000000;height:27px;text-decoration:none;">&nbsp;&nbsp;get support&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<span class="myxs"><input type="password" id="Password" name="Password" placeholder="new password" style="font-size:11px;">&nbsp;&nbsp;<a href="#" onclick="showEncodedPassword();" style="position:relative; left:0px; top:+2px; font-size:13px; font-weight:900; color:#518dc1;"><?php echo(getResource("Hash Me", $curLocale));?>!</a><span>
 </div>     
